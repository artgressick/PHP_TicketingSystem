      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="20">
        <tr>
          <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
              <td><span style="font-weight: bold">First Name</span> <span class="sosumi">(required)</span> <br>
            ...
            <tr>
              <td colspan="2"><span style="font-weight: bold">Apple Developer Connection ID</span><br>
                <input name="chrWWDR" type="text" id="chrWWDR" size="30" maxlength="20"> </td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
...
Stay in touch! Keep me up to date with Apple news, software updates, and the latest information on products and services to help me make the most of my Apple products. </td>
            ...
            <tr>
              <td colspan="2"><input name="Submit" type="submit" onClick="YY_checkform('form1','chrFirst','#q','0','Please enter your First Name.','chrLast','#q','0','Please enter your Last Name.','chrCompany','#q','0','Please enter your Company Name.','chrEmail','#q','0','Please enter you Email Address.');return document.MM_returnValue" value="Submit">
                <input name="idType" type="hidden" id="idType" value="3"></td>
            </tr>
            <tr>
