      ...
      <table width="100%"  border="0" cellspacing="0" cellpadding="20">
        <tr>
          <td><table width="100%"  border="0" cellspacing="0" cellpadding="3">
            ...
            <tr>
              <td><p><span style="font-weight: bold">First Name</span> <span class="sosumi">(required) </span><br>
                  <input name="chrFirst" type="text" id="chrFirst" size="30" maxlength="30">
              </p>                </td>
              <td><span style="font-weight: bold">Last Name</span> <span class="sosumi">(required) </span><br>
            ...
            <tr>
              <td colspan="2"><span style="font-weight: bold">Department Name</span> <span class="sosumi">(required)</span><br>
                <input name="chrDivisionDepartment" type="text" id="chrDivisionDepartment" size="45" maxlength="45">                </td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td colspan="2"><input name="Submit" type="submit" onClick="YY_checkform('form1','chrFirst','#q','0','Please enter your First Name.','chrLast','#q','0','Please enter your Last Name.','chrEmail','#q','0','Please enter your Email Address.','chrDivisionDepartment','#q','0','Please enter your Division/Department Number.');return document.MM_returnValue" value="Submit">
                <input name="idType" type="hidden" id="idType" value="4"></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
