...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="786" bgcolor="#3F3F3F">
        ...
        <tr>
          <td width="100%" class="title">General Registration </td>
          </tr>
        <tr>
          <td><div id='errors'></div></td>
          </tr>
		<tr>
          <td height="45" class="disclaimer"><p>Thank you for your interest in attending Apple's Special Presentation at NAB 2007.</p>
              <p>We are no longer accepting registrations for this event.</p>
              <p>Please visit us on the exhibit floor at NAB. We are in the South Hall on the ground level, booth number SL5520.</p>
              <p>Thank you!</p></td>
          </tr>
        <tr>
