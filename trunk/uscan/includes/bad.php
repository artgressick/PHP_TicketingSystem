  ...
  <tr>
    ...
    <td bgcolor="#ffffff">
      <table width="100%"  border="0" cellspacing="0" cellpadding="15">
        <tr>
          <td align="center" id=cont><img src="images/invite.gif" width="306" height="87">
          </td>
        </tr>
        <tr>
          <td align="center" id=cont><p><span class="style2">Error <?php echo "{$attendee['chrFirst']}"; ?> <?php echo "{$attendee['chrLast']}"; ?></span></p>
          <p>Our records indicate that this badge has already been checked in.</p></td>
        </tr>
        <tr>
          <td align="center" id=cont><span class="style3"><a href="finish://">Click here to finish</a></span></td>
        </tr>
      </table>
    </td>
